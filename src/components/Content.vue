            ...
            <div id="scrollbar" class="art-scroll-frame">
                    ...
                    <div class="art-a art-banner" style="background-image: url(img/bg.jpg)">
                      ...
                      <div class="art-banner-overlay">
                        ...
                        <div class="art-banner-title">
                          <!-- title -->
                          <h1 class="mb-15">Discover my <br></h1>
                          <!-- suptitle -->
                          <div class="art-lg-text art-code mb-25">&lt;<i>code</i>&gt; I build <span class="txt-rotate" data-period="2000"
                              data-rotate='[ "web apps.", "database.", "user interfaces.", "automation tools." ]'></span>&lt;/<i>code</i>&gt;</div>
                          <div class="art-buttons-frame">
                            <!-- button -->
                            <a href="/nazar/arter-demo/portfolio-3-col-masonry.html" class="art-btn art-btn-md"><span>Explore now</span></a>
                          </div>
                        </div>
                        <!-- main title end -->
                        <!-- photo -->
                      <!--   <img src="https://elanta.app/nazar/arter-demo/img/face-2.png" class="art-banner-photo" alt="Your Name"> -->
                      </div>
                      <!-- banner overlay end -->
                    </div>
                    <!-- banner end -->
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="art-a art-price">
                      ...
                      <div class="art-price-body">
                        ...
                        <!-- price list end -->
                        <!-- button -->
                        <a href="/nazar/arter-demo/contact.html" class="art-link art-color-link art-w-chevron">Order now</a>
                      ...
                      <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                          ...
                          <div class="art-a art-testimonial">
                            ...
                            <div class="testimonial-body">
                              <!-- photo -->
                              <img class="art-testimonial-face" src="https://elanta.app/nazar/arter-demo/img/testimonials/face-1.jpg" alt="face">
                              <!-- name -->
                              <h5>Paul Trueman</h5>
                              <div class="art-el-suptitle mb-15">Template author</div>
                              <!-- text -->
                              <div class="mb-15">Working with Bakhtiyor has been a pleasure. Better yet - I alerted them of a minor issue before going to sleep. The issue was fixed the next morning. I couldn't ask for better support. Thank you Bakhtiyor!
                        ...
                        <div class="swiper-slide">
                          ...
                          <div class="art-a art-testimonial">
                            ...
                            <div class="testimonial-body">
                              <!-- photo -->
                              <img class="art-testimonial-face" src="https://elanta.app/nazar/arter-demo/img/testimonials/face-2.jpg" alt="face">
                              <!-- name -->
                              <h5>Paul Trueman</h5>
                              <div class="art-el-suptitle mb-15">Template author</div>
                              <!-- text -->
                        ...
                        <div class="swiper-slide">
                          ...
                          <div class="art-a art-testimonial">
                            ...
                            <div class="testimonial-body">
                              <!-- photo -->
                              <img class="art-testimonial-face" src="https://elanta.app/nazar/arter-demo/img/testimonials/face-3.jpg" alt="face">
                              <!-- name -->
                              <h5>Paul Trueman</h5>
                              <div class="art-el-suptitle mb-15">Template author</div>
                              <!-- text -->
                        ...
                        <div class="swiper-slide">
                          ...
                          <div class="art-a art-testimonial">
                            ...
                            <div class="testimonial-body">
                              <!-- photo -->
                              <img class="art-testimonial-face" src="https://elanta.app/nazar/arter-demo/img/testimonials/face-4.jpg" alt="face">
                              <!-- name -->
                              <h5>Paul Trueman</h5>
                              <div class="art-el-suptitle mb-15">Template author</div>
                              <!-- text -->
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <div class="col-6 col-lg-3">
                    <!-- brand -->
                    <img class="art-brand" src="https://elanta.app/nazar/arter-demo/img/brands/1.png" alt="brand">
                  </div>
                  <!-- col end -->
                  ...
                  <div class="col-6 col-lg-3">
                    <!-- brand -->
                    <img class="art-brand" src="https://elanta.app/nazar/arter-demo/img/brands/2.png" alt="brand">
                  </div>
                  <!-- col end -->
                  ...
                  <div class="col-6 col-lg-3">
                    <!-- brand -->
                    <img class="art-brand" src="https://elanta.app/nazar/arter-demo/img/brands/3.png" alt="brand">
                  </div>
                  <!-- col end -->
              ...
              <div class="container-fluid">
                ...
                <footer>
                  ...
                  <div>© 2020 Bakhtiyor Alijanov</div>
